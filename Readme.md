...
1. 유저 프로필 설정을 통한 커뮤니케이션 비용 절감
2. 태그를 이용한 기술 스택, 포지션 설정의 필터링
3. 팀빌딩 필수 요소를 확인하는 간단 시험
...
#### Entity 정의
> domain 정의 및 property, entity 추출
...
## 환경 구축
> virtual box를 통한 linux기반 Ubuntu 서버 구축
